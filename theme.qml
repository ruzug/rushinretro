...
FocusScope {
    ...
    property var dataText: {
        "en": {
            ...
            sort_label_release:"Release Date",
            sort_label_rating:"Rating",
            sort_label_genre:"Genre",
            sort_label_last_played:"Last Played",
            sort_label_favorite:"Favorite",
            sort_label_custom:"Custom"
        },
       "ch": {
		...
		"es": {
            settings_collection_accentColor_dimm: "dimm",
            settings_collection_accentColor_bright: "bright",
            settings_general_colorScheme_Dark: "Oscuro",
            settings_general_colorScheme_Light: "Claro",
            settings_general_colorScheme_OzoneDark: "OzoneDark",
            settings_general_colorScheme_SteamOS: "SteamOS",
            settings_general_logoVariant_mono: "mono",
            settings_general_logoVariant_color: "color",
            global_yes: "Sí",
            global_no: "No",
            global_back: "VOLVER <b>ATRÁS</b>",
            global_select: "CONFIRMAR",
            global_games: "JUEGOS DE",
            global_noFavorites: "No hay favoritos establecidos",
            global_noFilteredGames: "No se han encontrado resultados para la búsqueda",
            global_switch: "CAMBIAR",
            global_collCategory: "CATEGORÍA DE COLECCIÓN",
            global_collections: "Colecciones",
            collection_all: "Todos",
            collection_favorites: "Favoritos",
            collection_lastplayed: "Último jugado",
            collectionDetails_gamesAvailable: "juegos disponibles",
            games_na: "",
            games_developedBy: "Desarrollado por",
            games_for: "por",
            games_players: "JUGADORES",
            games_player: "1 JUGADOR",
            games_favorited: "EN FAVORITOS",
            games_arcadeport: "Arcade Port",
            games_completed: "COMPLETADO",
            games_withoutDescription: "",
            games_removeFavorite: "ELIMINAR <b>FAVORITO</b>",
            games_addFavorite: "AÑADIR A <b>FAVORITOS</b>",
            games_filtered: "<b>FILTROS</b>",
            games_filterMultiplayer: "Multijugador",
            games_filter: "FILTROS",
            games_sortedBy: "ORDENADO POR",
            home_continue: "Seguir jugando",
            home_favorites: "Favoritos",
            home_play: "Jugar",
            settings_general: "General",
            settings_general_restart: "(Requiere reiniciar)",
            settings_general_language: "Idioma",
            settings_general_colorScheme: "Esquema de color",
            settings_general_selectionFrame: "Color del marco de selección",
            settings_general_music: "Música",
            settings_general_muteSounds: "Silenciar sonidos",
            settings_general_logoVariant: "Variación del logo",
            settings_general_region: "Región",
            settings_general_hideOSC: "Ocultar controles",
            ...
            settings_global_ImgPrecompose: "Utilizar imagen precompuesta",
            settings_global_ImgPrecomposePref: "Tipo de imagen precompuesta",
            settings_collection_showAll: 'Mostrar la colección "Todos los juegos"',
            settings_collection_showFavorites: 'Mostrar la colección "Favoritos"',
            settings_collection_showLastPlayed: 'Mostrar la colección "Últimos jugados"',
            settings_collection_accentColor: "Brillo del color de detalle",
            settings_collection_accentColorNr: "Color de detalle",
            settings_collection_menuColor: "Variación del color de desarrollador",
            settings_games_layout: "Disposición de los videojuegos",
            settings_games_gridItemsPerRow: "Cuadrícula de juegos - columnas visibles",
            settings_games_gridItemsViewableRows: "Cuadrícula de juegos - filas visibles",
            settings_games_BoxArtPref: "Preferir imagen de caja",
            settings_games_page_updown_function: "Cuadrícula de juegos - Función de los botones LT/RT",
            settings_home_videoLogo: "Mostrar logo cuando se muestra el vídeo",
            menu_settings: "Ajustes",
            menu_home: "Inicio",
            menu_collections: "Colecciones",
            menu_games:"Juegos",
            sort_label_title:"Título",
            sort_label_release:"Fecha de Salida",
            sort_label_rating:"Valoración",
            sort_label_genre:"Género",
            sort_label_last_played:"Último Jugado",
            sort_label_favorite:"Favorito",
            sort_label_custom:"Personalizado"
        }
    }
